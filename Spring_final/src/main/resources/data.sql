...
-- PC 카테고리 상품
INSERT INTO product (name, description, price, image_url, category, created_at, view_count) 
...
'SMARTPHONE', CURRENT_TIMESTAMP, 0);
